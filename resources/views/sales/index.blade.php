...
@section('pageTitle', 'Bills Management')

@section('content')
<div class="row">
    <div class="col-xs-4 mb-2">
       <!-- <input type="text" class="form-control" id="serach" name="serach" placeholder="Search Party">    -->           
    </div>
    <div class="col-xs-8 mb-2">
	   <a href="{{ route('sales.create') }}" class="btn btn-primary pull-right"><i class="fa fa-plus mr-1"></i>Add Bill</a>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Bills Listing</h3>
