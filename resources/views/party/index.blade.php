...
@section('pageTitle', 'Party Management')
...
<div class="row">
    ...
    <div class="col-xs-8 mb-2">
	   <a href="{{ route('party.create') }}" class="btn btn-primary pull-right"><i class="fa fa-plus mr-1"></i>Add Party</a>
    </div>
</div>
<div class="row">
    <div class="col-xs-12">
