    ...
    <div class="row">
		      ...
		      <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header bg-aqua">
                  <div class="widget-user-image">
                    <span class="info-box-icon bg-aqua"><i class="fas fa fa-building"></i></span>
                  </div>
                  <!-- /.widget-user-image -->
                ...
                <div class="box-footer no-padding">
                  <ul class="nav nav-stacked">
                    <li><a href="{{ url('/search/company') }}"><i class="fas fa-eye" aria-hidden="true"></i> &nbsp;Search Company</a></li>
                  </ul>
                </div>
		      </div>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="box box-widget widget-user-2">
                ...
                <div class="widget-user-header bg-navy">
                  <div class="widget-user-image">
                    <span class="info-box-icon bg-navy"><i class="fad fa fa-user-tie"></i></span>
                  </div>
                  <!-- /.widget-user-image -->
                  <h5 class="widget-user-desc">&nbsp;</h5>
                  <h3 class="widget-user-username">Professional</h3>
                  <h5 class="widget-user-desc">&nbsp;</h5>
                </div>
                <div class="box-footer no-padding">
                  <ul class="nav nav-stacked">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
		      {{--<div class="box box-widget widget-user-2">
                ...
                <div class="box-footer no-padding">
                  <ul class="nav nav-stacked">
                    <li><input type="text" class="form-control" name="search" /></li>
                    <li style="display: flex">
                        <a href=""><i class="fas fa-eye" aria-hidden="true"></i> &nbsp;View All</a>
                        <a href=""><i class="fas fa-money-check-alt" aria-hidden="true"></i> &nbsp;Outstanding</a>
                    </li>
                  </ul>
                </div>
		      </div>--}}
