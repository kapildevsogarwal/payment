...
@section('pageTitle', 'Search Professional Listing')

@section('content')
<div class="row">
    <div class="col-xs-4 mb-2">
        <input type="text" class="form-control" id="serach" name="serach" placeholder="Search Professional">               
    </div>
    ...
    <div class="col-xs-12">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Profesional Listing</h3>
            ...
            <div class="box-body table-responsive">
                <table class="table table-striped" id="professional-list">
                    ...
                    <tbody>
                         @include('search.search-professional-data')
                    </tbody>
                </table>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            function fetch_data(page, query) {
                $.ajax({
                    url: BASE_URL + "search/search-query-professional?page=" + page + "&query=" + query,
                    beforeSend: function () {
