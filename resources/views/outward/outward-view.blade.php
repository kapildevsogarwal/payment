...
<div class="row">
    ...
    <div class="col-xs-8 mb-2">
            ...
            <a href="{{ route('sales.create') }}" class="btn btn-primary pull-right"><i class="fa fa-plus mr-1"></i>Add Sales Bill</a>
    ...
    <div class="col-xs-12">
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title pull-left">Outward Tax (Sales Bill) <strong></strong></h3>
                ...
                <table class="table table-striped">
                    <tbody>
						...
						<tr>
                            ...
                            <td width="26.66%" >
								<strong>Total IGST Due Till Now</strong>
                            </td>
							 <td width="26.66%">
								<strong>Total CGST Due Till Now</strong>
                            </td>
							 <td width="26.66%">
								<strong>Total SGST Due Till Now</strong>
                            </td>
                        </tr>
						 <tr>
        ...
        $(document).ready(function(){
			...
			$("#select-month").change(function() {console.log('yes');
				...
				if(getSelect !=''){ console.log("dddd");
					...
					var _Url = BASE_URL + 'outward/get-month-sales-total';
					$.ajax({
						type: "get",
						url: _Url,
						data: 'month='+$(this).val(),
